...
Test(bsq, intermediate_map_one_empty_column)
{
...
Test(bsq, intermediate_map_one_filled_column)
{
    char map_test[] = "mouli_maps/"
...
Test(bsq, intermediate_map_one_column_with_obstacles_25pc)
{
    char map_test[] = "mouli_maps/"
...
Test(bsq, intermediate_map_one_column_with_obstacles_50pc)
{
    char map_test[] = "mouli_maps/"
...
Test(bsq, intermediate_map_one_column_with_obstacles_75pc)
{
    char map_test[] = "mouli_maps/"
